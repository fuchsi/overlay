...
src_prepare() {
	...
	sed -i -e "/^Icon/ s:${PN}:${PN}-2.7:" ${PN}2.desktop || die "Icon name fix failed."
	...
	mv ${PN}2.desktop ${PN}-2.7.desktop || die "Collision rename failed."
...
src_install() {
	...
	newicon ${PN}_icon.png ${PN}-2.7.png
